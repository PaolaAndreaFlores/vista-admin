      ...
      <div class="modal-dialog modal-dialog-vertical" role="document">
        <form class="modal-content" v->
          <div class="modal-body">
           ...
           <a class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" v-model="add.city"  placeholder="Ejemplo La paz">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Terminal :</label>
              <input type="text" class="form-control" v-model="add.terminal"  placeholder="Ejemplo Terminal La Paz">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Direccion :</label>
              <input type="text" class="form-control" v-model="add.address"  placeholder="Ejemplo Av. Hernando Siles">
            </div>
          ...
          <div class="modal-footer border-0">
            ...
            <!-- Button -->
            <button type="button"  @click="NUEVA_RUTA()" class="btn btn-block btn-primary mt-auto">
              Registrar
            </button>
        ...
        <h6 class="navbar-heading">
          ...
          <!-- <li class="nav-item">
            ...
            <li class="nav-item active">
              <a class="nav-link active" href="ruta.php">
          ...
          <div class="navbar-user d-none d-md-flex flex-column" id="sidebarSmallUser">
            ...
            <div class="dropright">
              ...
              <div class="dropdown-menu" aria-labelledby="sidebarSmallIconCopy">
                ...
                <hr class="dropdown-divider">
                <a href="sign-in.html" @click="logout" class="dropdown-item">Logout</a>
              </div>
...
<div class="row justify-content-center">
  ...
  <div class="card">
    ...
    const app = new Vue({
      ...
      axios
        .get(
          "http://192.168.0.13:3000/api/route/",{
    ...
    NUEVA_RUTA(){
      const token = localStorage.getItem('token')
            axios
              .post(
                "http://192.168.0.13:3000/api/route/register",this.add,{
    ...
    OnClickDelete(id){
      axios
        .delete(
          "http://192.168.0.13:3000/api/route/"+id,{
              headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
          }
        )
        .then((resp) => {
